"""
data_sources/combos.py — Query combo packages from DB.
"""
...
async def fetch_combos(destination: str) -> dict:
    """Return combo packages for a destination as a Python dict."""
    pool = await get_pool()
    ...
    try:
        ...
        return {"success": False, "error": str(e), "combos": []}
    ...
    return {"success": True, "count": len(combos), "combos": combos}
